...
<div class="flex flex-row h-auto order-4  justify-self-end grow justify-start items-end pb-24"> 
  <dotlottie-player
    class=""
    autoplay=""
    subframe=""
...
> 
  ...
  <div class="flex justify-center z-1 relative order-2 md:order-3">
    <div class="md:absolute left-0 top-0 h-[50vh] md:-top-40  md:h-[90vh] md:translate-x-1/4 z-[0]">
